...
export function SectionDetailsDrawer({
  ...
  return (
    <div className="flex h-full w-[26rem] shrink-0 flex-col border-l border-line bg-panel">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 thin-scroll">
        ...
        {section.current_stage === "stain_requested" && assayTypes.includes("stain") && (
          <ProtocolChecklist
            ...
            onStepChange={(sortOrder, complete) =>
              syncAssayWorkflowStep(section.id, "stain", sortOrder, complete)
            }
          />
        )}
        {section.current_stage === "stain_requested" && assayTypes.includes("ihc") && (
          <ProtocolChecklist
            scopeType="section_request"
            scopeId={section.id}
            ...
            onStepChange={(sortOrder, complete) =>
              syncAssayWorkflowStep(section.id, "ihc", sortOrder, complete)
            }
          />
        )}
      ...
      <div className="border-t border-line px-4 py-3">
        ...
        {section.current_stage === "stain_requested" && (
          <p className="mb-2 text-xs text-amber-700">
            Complete every applicable stain/IHC workflow step. Refrax and coverslipping move the slides to Ready for Imaging automatically.
          </p>
        )}
        ...
        {section.current_stage === "needs_sectioning" ? (
          ...
          <Button
            variant="primary"
            className="flex-1"
            onClick={() => run(() => moveSection(section.id, "pictures_taken"))}
          >
            <CheckCircle2 size={15} /> Pictures Taken
          </Button>
          ...
          <Button variant="primary" className="flex-1" onClick={() => markSectionAnalyzed(section.id)}>
            <CheckCircle2 size={15} /> Mark Analyzed
          </Button>
        )}
        <Button
          variant="danger"
